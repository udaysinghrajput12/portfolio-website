...
const Achievements = () => {
  ...
  return (
    <section ref={sectionRef} className="py-40 md:py-64 px-6 md:px-16 lg:px-32 transition-colors duration-500 bg-transparent border-t border-black/5 dark:border-white/5 relative w-full overflow-hidden">
