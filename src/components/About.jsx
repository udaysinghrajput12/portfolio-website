...
const About = () => {
  ...
  return (
    <section ref={sectionRef} className="py-40 md:py-64 px-6 md:px-16 lg:px-32 bg-[#0B0B0F] relative z-10 w-full overflow-hidden">
      <div className="max-w-[90rem] mx-auto flex flex-col md:flex-row gap-24 md:gap-32 w-full">
        <div className="w-full md:w-1/4 shrink-0">
          <h3 className="text-xs tracking-[0.2em] text-[#D4AF37] uppercase font-medium">01. About</h3>
        </div>
        <div className="w-full md:w-3/4">
          <p ref={textRef} className="text-3xl md:text-5xl lg:text-7xl font-display font-light leading-[1.35] text-[#EAEAEA] max-w-5xl">
